      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            navigate("/mywins"); // User wants My Wins page!
          } catch(err) {
                ...
                <div className="bg-red-50 border-t border-red-100 px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[11px] text-red-500 font-medium ml-7 opacity-80 decoration-dotted underline">
                        Ends: {new Date(data.itemEndDate).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}
                      </span>
                    </div>
              ...
              <div className="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-2xl border border-amber-200 shadow-sm p-6">
                ...
                {winnerData._id === currentUserId && (
                  <div className="mt-4 flex flex-col gap-3">
                    <div className="bg-amber-100 text-amber-800 text-sm font-medium px-4 py-2 rounded-xl">
                    ...
                    {data.paymentStatus === "pending" ? (
                      <button
                        ...
                        disabled={paying}
                        className="bg-green-600 text-white font-bold py-2.5 px-4 rounded-xl shadow hover:bg-green-700 transition"
                      >
                        {paying ? "Processing..." : "Pay Now with Razorpay"}
                      </button>
                    ) : data.paymentStatus === "paid" ? (
                      <div className="bg-green-100 text-green-800 text-sm font-medium px-4 py-2 rounded-xl border border-green-200 text-center">
                        ✅ Payment Completed
                      </div>
                    ) : null}
                  </div>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs text-gray-400">
                    Rs {data.currentPrice + 1} or more
                  </span>
                </div>
